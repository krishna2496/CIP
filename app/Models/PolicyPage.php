...
class PolicyPage extends Model
{
    ...
    {
        return $this->hasMany(PolicyPagesLanguage::class, 'page_id', 'page_id');
    }
     ...
     * @return bool
     */
    public function deletePolicyPage(int $id): bool
    {
        return static::findOrFail($id)->delete();
    }
    
    /**
     * Get the translations associated with the policy page.
     *
