...
class MissionApplicationController extends Controller
{
    ...
    public function missionApplication(Request $request): JsonResponse
    {
		...
		$validator = Validator::make(
            $request->all(),
            [
                "mission_id" => "integer|required|exists:mission,mission_id,deleted_at,NULL,publication_status,".config("constants.publication_status")["APPROVED"].",publication_status,".config("constants.publication_status")["PUBLISHED_FOR_APPLYING"],
