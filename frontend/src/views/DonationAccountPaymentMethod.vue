    ...
    <main>
        <b-container>
                    ...
                    <b-row class="row-form">
                        <b-col cols="12">
                            <h2 class="title-with-border">
                                <span>{{languageData.label.payment_method}}</span>
                            </h2>
                        </b-col>
                        <b-col md="6">
                            <div class="payment-card">
                                ...
                                <div class="text-wrap">
                                    <h4>{{languageData.label.master_card}}</h4>
                                    <p>1485 **** **** 0236</p>
                                    <p class="expire-date">{{languageData.label.expire}}: 05/22</p>
                                </div>
                                <div class="ellipse-menu-wrap">
                                    ...
                                    <ul class="ellipse-menu">
                                        <li>
                                            <i class="edit-icon">
                                                <img :src="`${$store.state.imagePath}/assets/images/edit-ic.svg`" /> </i>{{languageData.label.edit}}
                                        </li>
                                        <li>
                                            <i class="delete-icon">
                                                <img :src="`${$store.state.imagePath}/assets/images/delete-ic-g.svg`" /> </i>{{languageData.label.remove}}
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <b-col md="6">
                            <div class="payment-card">
                                ...
                                <div class="text-wrap">
                                    <h4>{{languageData.label.master_card}}</h4>
                                    <p>1485 **** **** 0236</p>
                                    <p>{{languageData.label.expire}}: 05/22</p>
                                </div>
                                <div class="ellipse-menu-wrap">
                                    <i class="ellipse-icon">
                                        <img :src="$store.state.imagePath+'/assets/images/ellipse.png'" alt="ellipse" />
                        ...
                        <b-col md="6">
                            <div class="payment-card add-payment" @click="$refs.editPaymentModal.show();">
                                + {{languageData.label.add_payment_method}}
                            </div>
                        </b-col>
                    </b-row>
                </b-col>
            ...
            <b-modal ref="changePasswordModal" :modal-class="'password-modal sm-popup'" centered hide-footer>
                ...
                }" :placeholder="languageData.placeholder.confirm_password" @keypress.enter.prevent="changePassword" type="password">
                        </b-form-input>
                        <div v-if="
