        ...
        <b-container>
                ...
                <b-col xl="9" lg="8" md="12" class="recurring-payment-content">
                    <b-list-group class="status-bar">
                        ...
                        <b-list-group-item>
                            <div class="list-item">
                                <i class="amount-icon">
                                    <img :src="`${$store.state.imagePath}/assets/images/amount-ic.svg`" alt="amount-ic" />
                                </i>
                                <p><span>€ 1857</span>{{languageData.label.active_recurring_amount}}</p>
                            </div>
                        </b-list-group-item>
                        <b-list-group-item>
                            <div class="list-item">
                                <i class="plans-icon">
                                    <img :src="`${$store.state.imagePath}/assets/images/plans-ic.svg`" alt="plans-ic" />
                                </i>
                                <p><span>50</span>{{languageData.label.average_recurring_plans}}</p>
                            </div>
                        </b-list-group-item>
                    </b-list-group>
                    <div class="dashboard-table recurrence-table">
                        <div class="table-outer">
                            <div class="table-inner">
                                <div class="title-block">
                                    <h3>{{languageData.label.recurring_donations}}</h3>
                                    <div class="dropdown-block">
                                        <!-- <AppCustomDropdown :optionList="dateRangeList" @updateCall="updateDateRange"
                        :defaultText="defaultDateRange" translationEnable="false" /> -->
                                ...
                                <b-table-simple responsive sortable>
                                    <b-thead>
                                        <b-tr>
                                            <b-th class="status-column">{{languageData.label.status}}</b-th>
                                            <b-th class="date-column" sortable>{{languageData.label.created}}
                                                <i class="sorting-arrows">
                                                    <img :src="`${$store.state.imagePath}/assets/images/sortable-ic.svg`" alt="sortable-ic.svg" />
                                                </i>
                                            </b-th>
                                            <b-th class="name-column" sortable>{{languageData.label.first_name}}
                                                <i class="sorting-arrows">
                                                    <img :src="`${$store.state.imagePath}/assets/images/sortable-ic.svg`" alt="sortable-ic.svg" />
                                                </i>
                                            </b-th>
                                            <b-th class="frequency-column" sortable>{{languageData.label.frequency}}
                                                <i class="sorting-arrows">
                                                    <img :src="`${$store.state.imagePath}/assets/images/sortable-ic.svg`" alt="sortable-ic.svg" />
                                                </i>
                                            </b-th>
                            ...
                            <div class="pagination-block">
                                <b-pagination :hide-ellipsis="hideEllipsis" :total-rows="rows" :per-page="page" align="center" v-model="currentPage">
                                </b-pagination>
                            </div>
                        </div>
                    </div>
            ...
            <b-modal ref="editPaymentModal" :modal-class="'payment-modal md-popup'" centered hide-footer>
                <template slot="modal-header" slot-scope="{ close }">
                    ...
                    <h5 class="modal-title">
                        {{languageData.label.payment_method}}
                    </h5>
                </template>
                <h4 class="title-with-border">
                    <span>{{languageData.label.add_credit_or_debit_card}}</span>
                </h4>
                <form action class="form-wrap">
                    ...
                    <b-row class="row-form">
                        <b-col col="12">
                            <b-form-group>
                                <label>{{languageData.label.address}}*</label>
                                <b-form-input type="text" :placeholder="languageData.placeholder.enter_your_address"></b-form-input>
                            </b-form-group>
                        </b-col>
                    </b-row>
                    <b-row class="row-form">
            ...
            <b-modal ref="changePasswordModal" :modal-class="'password-modal sm-popup'" centered hide-footer>
                ...
                <form action class="form-wrap">
                    ...
                    <b-form-group>
                        <b-form-input id type="password" v-model.trim="resetPassword.newPassword" :class="{ 'is-invalid': passwordSubmit && $v.resetPassword.newPassword.$error }" :placeholder="languageData.placeholder.new_password"></b-form-input>
                    ...
                    <b-form-group>
                        <b-form-input id v-model.trim="resetPassword.confirmPassword" :class="{ 'is-invalid': passwordSubmit && $v.resetPassword.confirmPassword.$error }" :placeholder="languageData.placeholder.confirm_password" @keypress.enter.prevent="changePassword" type="password">
                        </b-form-input>
