      ...
      <b-container>
              ...
              <b-list-group class="social-nav">
                <b-list-group-item>
                  <b-link href="#" target="_blank" class="linkedin-link">
                    <img src="../assets/images/linkedin-ic-blue.svg" class="normal-img" alt="linkedin img" />
                    <img src="../assets/images/linkedin-ic.svg" class="hover-img" alt="linkedin img" />
                  </b-link>
                </b-list-group-item>
              </b-list-group>
              <div class="link-wrap">
              ...
              <b-list-group-item>
                <div class="list-item">
                  <i class="currency-icon">
                    <img src="../assets/images/currency-ic.svg" alt="currency-ic" />
                  </i>
                  <p><span>€ 50</span>Average recurring amount</p>
                </div>
              </b-list-group-item>
              <b-list-group-item>
                <div class="list-item">
                  <i class="amount-icon">
                    <img src="../assets/images/amount-ic.svg" alt="amount-ic" />
                  </i>
                  <p><span>€ 1857</span>Active recurring amount</p>
                </div>
              </b-list-group-item>
              <b-list-group-item>
                <div class="list-item">
                  <i class="plans-icon">
                    <img src="../assets/images/plans-ic.svg" alt="plans-ic" />
                  </i>
                  <p><span>50</span>Average Recurring Plans</p>
                </div>
              </b-list-group-item>
            </b-list-group>
              ...
              <div class="table-outer">
                <div class="table-inner">
                  ...
                  <b-table-simple responsive sortable>
                    <b-thead>
                      <b-tr>
                        <b-th class="status-column">Status</b-th>
                        <b-th class="date-column" sortable>Created
                          <i class="sorting-arrows">
                            <img src="../assets/images/sortable-ic.svg" alt="sortable-ic.svg" />
                          </i>
                        </b-th>
                        <b-th class="name-column" sortable>Name
                          <i class="sorting-arrows">
                            <img src="../assets/images/sortable-ic.svg" alt="sortable-ic.svg" />
                          </i>
                        </b-th>
                        <b-th class="frequency-column" sortable>Frequency
                          <i class="sorting-arrows">
                            <img src="../assets/images/sortable-ic.svg" alt="sortable-ic.svg" />
                          </i>
                        </b-th>
                        <b-th class="amount-column">Amount</b-th>
                        <b-th class="method-column">Method</b-th>
                      </b-tr>
                    </b-thead>
                    <b-tbody>
                      <b-tr>
                      ...
                      <b-tr>
                        ...
                        <b-td class="frequency-column">Monthly</b-td>
                        <b-td class="amount-column">€10,000</b-td>
                        <b-td class="method-column">Payroll</b-td>
                      </b-tr>
                      <b-tr>
                ...
                <div class="pagination-block">
                  <b-pagination :hide-ellipsis="hideEllipsis" :total-rows="rows" :per-page="page" align="center"
                    v-model="currentPage">
                  </b-pagination>
                </div>
              </div>
        ...
        <b-modal ref="editPaymentModal" :modal-class="'payment-modal md-popup'" centered hide-footer>
          ...
          <form action class="form-wrap">
            <b-row class="row-form">
              ...
              <b-col col="6">
                <b-row>
                  ...
                  <b-col col="6">
                    <b-form-group>
                      <label>CVV<span class="info-icon">(<span>?</span>)</span></label>
            ...
            <div class="btn-row">
              <b-button class="gray-btn" title="Cancel">Cancel</b-button>
              <b-button class="btn-fillsecondary" title="Save">Save</b-button>
            </div>
          </form>
        </b-modal>
      </b-container>
