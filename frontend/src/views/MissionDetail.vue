                                    ...
                                    <b-collapse id="mission" visible accordion="my-accordion" role="tabpanel" class="tab-content">
                                        ...
                                        <div v-if="missionDetail.mission_document && missionDetail.mission_document.length > 0">
                                            ...
                                            <div class="document-list-wrap">
                                                <div class="document-list-block" v-for="(document ,index) in missionDetail.mission_document" :key=index>
                                                    <!-- pdf -->
                                                    <template v-if="document.document_type =='pdf'">
                                                        <b-link :href="document.document_path" target="_blank" :title="document.document_name">
                                                            <AppCustomChip :textVal="document.document_name" class="has-img no-close" :url="bgImage[0]" />
                                                        </b-link>
                                                    </template>
                                                    <!-- doc -->
                                                    <template v-if="document.document_type =='doc' || document.document_type =='docx' ">
                                                        <b-link :href="document.document_path" target="_blank" :title="document.document_name">
                                                            <AppCustomChip :textVal="document.document_name" class="has-img no-close" :url="bgImage[1]" />
                                                        </b-link>
                                                    </template>
                                                    <!-- xls  xlsx-->
                                                    <template v-if="document.document_type === 'xls' || document.document_type === 'xlsx'">
                                                        <b-link :href="document.document_path" target="_blank" :title="document.document_name">
                                                            <AppCustomChip :textVal="document.document_name" class="has-img no-close" :url="bgImage[2]" />
                                                        </b-link>
                                                    </template>
                                                </div>
