              ...
              <b-list-group class="social-nav">
                <b-list-group-item>
                  <b-link href="#" target="_blank" class="linkedin-link">
                    <img
                      src="../assets/images/linkedin-ic-blue.svg"
                      class="normal-img"
                      alt="linkedin img"
                    />
                    <img
                      src="../assets/images/linkedin-ic.svg"
                      class="hover-img"
                      alt="linkedin img"
                    />
                  </b-link>
                          ...
                          <g>
                            <path
						      ...
						      c2.036-1.602,4.566-2.237,7.114-1.787c2.551,0.449,4.708,1.909,6.074,4.111C286.277,165.745,285.402,170.801,281.838,173.64z"
						                            />
						                            <path
						                              d="M148.558,131.669c31.886,0,57.827-25.941,57.827-57.827s-25.941-57.827-57.827-57.827S90.731,41.955,90.731,73.842
						      ...
						      c-23.549,0-42.707-19.159-42.707-42.707C105.851,50.293,125.01,31.135,148.558,31.135z"
						                            />
						                            <path
						                              d="M147.213,87.744c-2.24,0-4.618-0.546-6.698-1.538c-1.283-0.613-2.778-0.65-4.098-0.105
          ...
          <b-col xl="9" lg="8" md="12" class="profile-form-wrap">
            <b-form class="profile-form">
              <b-row class="row-form">
                ...
                <b-col md="6">
                  <b-form-group>
                    ...
                    <b-form-input type="text" placeholder="Enter your lastname">
                    </b-form-input>
                    <div class="invalid-feedback">
                      Error message !
                    </div>
                ...
                <b-col md="6">
                  <b-form-group>
                    ...
                    <b-form-input type="text" placeholder="Enter your title">
                    </b-form-input>
                  </b-form-group>
                </b-col>
                <b-col md="6">
              ...
              <b-row class="row-form">
                ...
                <b-col md="6">
                  <b-form-group>
                    <label for class="has-help-text">Personal Donation Goal
                      <b-button class="help-text" v-b-modal.helpModal>Help</b-button></label>
                    <b-form-input
                      type="text"
                      placeholder="Amount"
                    ></b-form-input>
                ...
                <b-col cols="12">
                  <div class="btn-wrapper">
                    <b-button class="btn-bordersecondary btn-save" title="Save"
                      >Save
                    </b-button>
                  </div>
                </b-col>
        ...
        >
          ...
          <form action class="form-wrap">
            <b-form-group>
              ...
              ></b-form-input>
              <div
                v-if="passwordSubmit && !$v.resetPassword.oldPassword.required"
            ...
            <b-form-group>
              ...
              ></b-form-input>
              <div
                v-if="passwordSubmit && !$v.resetPassword.newPassword.required"
                class="invalid-feedback"
              >
                {{ languageData.errors.field_is_required }}
              </div>
              <div
                v-if="passwordSubmit && !$v.resetPassword.newPassword.minLength"
                class="invalid-feedback"
              >
          ...
          <form action class="form-wrap">
            <div class="checkbox-group-wrap">
              <b-form-group class="site-checkbox">
                <b-form-checkbox class="custom-control-input"
                  >Allow all my <strong>co-workers</strong> to see my profile
                </b-form-checkbox>
              </b-form-group>
              <b-form-group class="site-checkbox">
                <b-form-checkbox class="custom-control-input"
                  >Allow <strong>public</strong> fundraisers and funds to view
                  my avatar and my linkedin
                </b-form-checkbox>
              </b-form-group>
            </div>
            <b-form-group class="preference-block">
              ...
              <model-select
                ...
                :options="timeList"
                v-model="selectTimeZone"
                :placeholder="'USA - US Dollars'"
                @input="updateTime"
              >
              </model-select>
            </b-form-group>
            <div class="btn-row">
              <b-button class="gray-btn cancel-btn" title="Cancel"
                >Cancel</b-button
              >
              <b-button class="btn-fillsecondary save-btn" title="Save"
                >Save</b-button
              >
            </div>
          </form>
