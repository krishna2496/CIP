                            ...
                            <div class="content-block">
                                ...
                                <div class="event-block has-progress">
                                    ...
                                    <div class="progress-block detail-column " v-if="checkMissionTypeDonation(mission.mission_type) && mission.donation_attribute.show_donation_meter">
                                        <div class="text-wrap">
                                            <b-progress :value="missionDetail.donation_attribute.donation_amount_raised" :max="missionDetail.donation_attribute.goal_amount"></b-progress>
                                            <div class="progress-info">
                                                ...
                                                <span class="subtitle-text">
                                                    <em><b>${{missionDetail.donation_attribute.goal_amount}}</b></em>
