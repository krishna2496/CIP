            ...
            <b-card no-body>
              ...
              <b-card-header>
                <div class="header-img-block">
                  <b-alert
                    show
                    class="alert card-alert alert-success"
                  ...
                  >
                  <div
                    v-if="checkDefaultMediaFormat(mission.default_media_type)"
                    class="group-img"
                    :style="{
                      backgroundImage:
                        'url(' + getMediaPath(mission.default_media_path) + ')',
                    }"
                  >
                    <img
                      :src="getMediaPath(mission.default_media_path)"
                ...
                <div
                  ...
                  v-if="mission.mission_theme != null && isThemeSet"
                >
              ...
              <b-card-body>
                <div class="content-block">
                  <div class="mission-label-wrap">
                    <div
                      class="mission-label volunteer-label"
                      v-if="
                    ...
                    >
                      <span
                        ...
                        ><i class="icon-wrap"
                          ><img
                            :src="volunteeringMissionTypeLabels.icon"
                            alt="volunteer icon"/></i
                        >{{ volunteeringMissionTypeLabels.label }}</span
                      >
                    </div>
                    <div
                      class="mission-label virtual-label"
                      v-if="mission.is_virtual == 1"
                    >
                      <span>{{ languageData.label.virtual_mission }}</span>
                    </div>
                    <div
                      class="mission-label donation-label"
                      v-if="
                        isDisplayMissionLabel &&
                    ...
                    >
                      <span
                        ...
                        ><i class="icon-wrap"
                          ><img
                            :src="donationMissionTypeLabels.icon"
                            alt="donation icon"/></i
                        >{{ donationMissionTypeLabels.label }}</span
                      >
                    </div>
                  </div>
                  <div class="content-inner-block">
                    ...
                    <b-link
                      target="_blank"
                      :to="'/donation-mission-detail/' + mission.mission_id"
                      class="card-title mb-2"
                    ...
                    >
                      <star-rating
                        v-if="isDonationMissionRatingEnabled"
                        v-bind:increment="0.5"
                        v-bind:max-rating="5"
                        inactive-color="#dddddd"
                        active-color="#F7D341"
                  ...
                  <div class="event-block has-progress">
                    ...
                    <!-- donation -->
                    <div
                      class="progress-block detail-column "
                      v-if="
                        checkMissionTypeDonation(mission.mission_type) &&
                    ...
                    >
                      <div class="text-wrap">
                        <b-progress
                          ...
                          "
                          :max="mission.donation_attribute.goal_amount"
                        ></b-progress>
                    ...
                    <div
                      class="progress-block detail-column success-donate"
                      v-if="
                        checkMissionTypeDonation(mission.mission_type) &&
                          !mission.donation_attribute.show_donation_meter
                      "
                ...
                <div class="init-hidden">
                  <div class="group-details">
                    ...
                    <template v-if="checkMissionTypeGoal(mission.mission_type)">
                      <div class="group-details-inner volunteer-progress">
                        ...
                        >
                          ...
                          <div class="text-wrap">
                            <b-progress
                              :value="mission.achieved_goal | filterGoal"
                    ...
                    >
                      <div
                        class="group-details-inner has-progress"
                        v-if="mission.donation_attribute.show_donation_meter"
                      >
                      ...
                      <div
                        class="group-details-inner"
                        v-if="!mission.donation_attribute.show_donation_meter"
                      >
                        <div
                          class="detail-column progress-block donate-success-detail"
                        >
                          <div class="text-wrap">
                            <p>
                              <b
    ...
    >
      <template slot="modal-header" slot-scope="{ close }">
        <i
          ...
          @click="close()"
          v-b-tooltip.hover
          :title="languageData.label.close"
        ></i>
      ...
      <b-form>
        <div class="btn-wrap">
          <b-button
            @click="$refs.userDetailModal.hide()"
    ...
    cardHeightAdj() {
      ...
      if (cardBodyList.length > 0) {
        ...
        cardBodyList.forEach((cardBody) => {
          ...
          const cardHeight =
            cardBody.children[0].offsetHeight + card.children[1].offsetHeight;
