	       ...
	       <ul class="profile-navs">
              ...
              <li>
                <b-link href="#" title="Preview Profile">
                  ...
                  >{{languageData.label.preview_profile}}
                </b-link>
              </li>
            </ul> 
            <b-modal
            ...
            <div class="checkbox-group-wrap">
              <b-form-group class="site-checkbox">
                <b-form-checkbox class="custom-control-input"
                  >{{languageData.label.allow_all_my}} <strong>{{languageData.label.co_workers}}</strong>{{languageData.label.to_see_my_profile}} 
                </b-form-checkbox>
              </b-form-group>
              <b-form-group class="site-checkbox">
                <b-form-checkbox class="custom-control-input"
                  >{{languageData.label.allow}} <strong>{{languageData.label.public}} </strong> 
