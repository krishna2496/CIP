...
<div class="top-header">
    <b-navbar toggleable="lg">
        <b-container>
            ...
            <b-navbar-brand :to="{ name: 'login' }" :style="{backgroundImage: 'url('+this.$store.state.logo+')'}" v-if="!this.$store.state.isLoggedIn">
            </b-navbar-brand>
                        ...
                        <ul class="dropdown-menu sub-dropdown">
                            <li v-if="isThemeDisplay" v-bind:class="topThemeClass">
                                ...
                                <ul class="subdropdown-menu" v-if="topTheme != null && topTheme.length > 0">
                                    <li v-for="(items, key) in topTheme" v-bind:key=key class="no-dropdown">
                                        <router-link :to="{ path: '/home/themes/'+items.id}" @click.native="menuBarclickHandler">
                                            {{ items.title}}
                                        </router-link>
                                    </li>
                                </ul>
                            ...
                            <li v-bind:class="topCountryClass">
                                ...
                                <ul class="subdropdown-menu" v-if="topCountry != null && topCountry.length > 0">
                                    <li v-for="(items, key) in topCountry" v-bind:key=key class="no-dropdown">
                                        <router-link :to="{ path: '/home/country/'+items.id}" @click.native="menuBarclickHandler">
                                            {{ items.title}}
                                        </router-link>
                                    </li>
                                </ul>
                            ...
                            <li v-bind:class="topOrganizationClass">
                                ...
                                <ul class="subdropdown-menu" v-if="topOrganization != null && topOrganization.length > 0">
                                    <li v-for="(items, key) in topOrganization" v-bind:key=key class="no-dropdown">
                                        <router-link :to="{ path: '/home/organization/'+items.id}" @click.native="menuBarclickHandler">
                                            {{ items.title}}
                                        </router-link>
                                    </li>
                                </ul>
                            ...
                            <li class="no-dropdown">
                                <router-link :to="{ path: '/home/most-ranked-missions'}" @click.native="menuBarclickHandler">
                                    {{languageData.label.most_ranked}}
                                </router-link>
                            </li>
                            <li class="no-dropdown">
                                <router-link :to="{ path: '/home/favourite-missions'}" @click.native="menuBarclickHandler">
                                    {{languageData.label.top_favourite}}
                                </router-link>
                            </li>
                            <li class="no-dropdown">
                                <router-link :to="{ path: '/home/recommended-missions'}" @click.native="menuBarclickHandler">
                                    {{languageData.label.recommended}}
                                </router-link>
                            </li>
                            <li class="no-dropdown">
                                <router-link :to="{ path: '/home/random-missions'}" @click.native="menuBarclickHandler">
                    ...
                    <li class="has-menu" v-show="isPolicyDisplay && policyPage.length > 0">
                        ...
                        <ul class="dropdown-menu" v-show="policyPage.length > 0">
                            <li v-for="(item, key) in policyPage" v-bind:key=key class="no-dropdown">
                                <router-link :to="{ path: '/policy/'+item.slug}" v-if="item.pages[0]" @click.native="menuBarclickHandler">
                                    {{item.pages[0].title}}
                                </router-link>
                            </li>
                        </ul>
            ...
            <div class="header-right ml-auto">
                <b-nav>
                    ...
                    <b-nav-item right class="notification-menu" id="notifyPopoverWrap" v-if="this.$store.state.isLoggedIn">
                        <button id="notificationPopover" class="btn-notification" @click="getNotificationSettingListing">
                            <i>
                ...
                <b-popover target="notificationPopover" placement="topleft" container="notifyPopoverWrap" ref="notficationPopover" triggers="click" custom-class="notification-popover">
                    <template slot="title">
                        <div>
            ...
            'unread-item' : item.is_read == 0
                                ...
                                <span v-b-tooltip.hover :title="getTooltipTitle(item.is_read)" class="status" v-on:click="readUnreadItem($event, item.is_read, item.notification_id)">
                                </span>
                        ...
                        <div class="setting-body" v-if="notificationSettingList.length > 0">
                            ...
                            <b-list-group data-simplebar>
                                <b-form-checkbox-group id="checkbox-group-2" v-model="selectedNotification" name="flavour-2">
                                    <b-list-group-item v-for="(data, index) in notificationSettingList" :key="index">
                                        <b-form-checkbox :value="data.notification_type_id">
                                            {{data.notification_type}} </b-form-checkbox>
                                    </b-list-group-item>
                                </b-form-checkbox-group>
                                <b-form-checkbox-group id="checkbox-group-1" v-model="getEmailNotificationSelected" name="flavour-1">
