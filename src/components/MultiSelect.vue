<template>
  <div>
    <div class="skillset-wrap">
      ...
      <b-button class="btn-borderprimary add-skill-btn" @click="showSkillModal" title="Add skills">Add Skills</b-button>
      <b-modal
        centered
      ...
      >
          ...
          <div class="options-col" data-simplebar>
            <ul class="fromlist-group">
              <li v-for="(fromitem, index) in fromList" :key="index" :id="fromitem.id">
                ...
                <b-button>
                  <img src="../assets/images/plus-ic.svg" alt="plus icon" />
                </b-button>
              </li>
            </ul>
          </div>
          <div class="options-col" data-simplebar>
            <ul class="tolist-group">
              <li v-for="(toitem, idx) in toList" :id="toitem.id" :key="idx">
                ...
                <b-button>
                  <img src="../assets/images/cross-ic.svg" alt="cross icon" />
                </b-button>
              </li>
            </ul>
          </div>
        ...
        <div class="btn-wrap">
          <b-button @click="$refs.skillModal.hide()" class="btn-borderprimary" title="Cancel">Cancel</b-button>
