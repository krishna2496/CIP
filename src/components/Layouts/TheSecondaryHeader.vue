                ...
                <b-col xl="7" lg="8" class="filter-block"  v-if="quickAccessFilterSet">
                    ...
                    <b-list-group>
                        <b-list-group-item v-if="isCountrySelectionSet">
                            <AppFilterDropdown :optionList="countryList" :defaultText="defaultCountry"
                                               translationEnable="false" @updateCall="changeCountry" v-if="isComponentVisible" />
                        </b-list-group-item>
                        <b-list-group-item v-if="isStateSelectionDisplay">
                            <AppCheckboxDropdown v-if="isComponentVisible" :filterTitle="defaultState"
                                                 :selectedItem="selectedState" :checkList="stateList" @updateCall="changeState" />
                        </b-list-group-item>
                        <b-list-group-item>
                            <AppCheckboxDropdown v-if="isComponentVisible" :filterTitle="defaultCity"
                                                 :selectedItem="selectedCity" :checkList="cityList" @updateCall="changeCity" />
                        </b-list-group-item>
                        <b-list-group-item v-if="isThemeDisplay">
                            <AppCheckboxDropdown v-if="isComponentVisible" :filterTitle="defaultTheme"
                        ...
                        <b-list-group-item v-if="isSkillDisplay">
                            <AppCheckboxDropdown v-if="isComponentVisible" :filterTitle="defaultSkill"
