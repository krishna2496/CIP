        ...
        <b-nav class="ml-auto">
          ...
          <b-nav-item-dropdown right class="profile-menu">
            <template slot="button-content">
              <i :style="{backgroundImage: 'url('+profileImages+')'}">
          ...
          <div class="notification-setting">
            ...
            <div class="setting-body">
              ...
              <b-list-group data-simplebar>
                <b-list-group-item>
                  <b-form-checkbox id="checkbox-1" value="accepted">Recommended Missions</b-form-checkbox>
                </b-list-group-item>
                <b-list-group-item>
                  <b-form-checkbox id="checkbox-2" value="accepted">Volunteering Hours</b-form-checkbox>
                </b-list-group-item>
                <b-list-group-item>
                  <b-form-checkbox id="checkbox-3" value="accepted">Volunteering Goals</b-form-checkbox>
                </b-list-group-item>
                <b-list-group-item>
            ...
            <div class="setting-footer">
              <!-- <a href="javascript:void(0)" class="btn-bordersecondary" title="Save">Save</a>
              <a
...
export default {
  ...
  methods: {
    ...
    cancelsetting() {
      ...
      //   this.$refs.notficationPopover.$emit("open");
    },
    openMenu() {
