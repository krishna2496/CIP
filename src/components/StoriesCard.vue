        ...
        <b-col lg="4" sm="6" class="card-outer" data-aos="fade-up">
          <b-card no-body>
            <b-card-header>
              ...
              <b-link class="btn btn-borderwhite icon-btn" title="View Details" to="/storiesdetail">
            ...
            <b-card-body>
              <div class="content-block">
                <div class="top-block">
                  ...
                  >10 User and Customer Engagement Strategies for 2019</b-link>
                  <b-card-text>
        ...
        <b-col lg="4" sm="6" class="card-outer" data-aos="fade-up">
          <b-card no-body>
            <b-card-header>
              ...
              <b-button class="btn-borderwhite icon-btn" title="View Details" to="/storiesdetail">
                <span>View Details</span>
                <i>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="content-block">
                <div class="top-block">
                  <b-link
                    ...
                    title="Grow Trees"
                    class="card-title mb-2"
                  >Overheard in Product: Good Products, the End of Failure.</b-link>
                  <b-card-text>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                    incididunt ut labore...
                  </b-card-text>
