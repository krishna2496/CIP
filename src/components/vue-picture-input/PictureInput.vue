	...
	<div ref="container" id="picture-input" class="picture-input">
		...
		<div v-else-if="supportsPreview">
			<div class="preview-container"
				...
				<img :src="prefillUrl" class="picture-preview" @drag.stop.prevent="" height="100%"
					@dragover.stop.prevent="" @dragstart.stop.prevent="onDragStart"
...
<script>
	export default {
		...
		methods: {
			...
			drawImage(image) {
				this.prefillUrl = image.getAttribute('src')
