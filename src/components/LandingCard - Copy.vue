        ...
        <div class="card-grid">
            <b-row>
                <b-col lg="4" sm="6" class="card-outer" data-aos="fade-up">
                        ...
                        <b-card-header>
                            <div class="header-img-block">
                                <b-link class="group-img" :style="{backgroundImage: 'url('+grpImages[0]+')'}">
                                    <img src="../assets/images/landing/group-img1.png" alt="group-img">
                                </b-link>
                                <b-link href="#" class="location" title="location">
                                    <i>
                                        <img src="../assets/images/landing/location.svg" alt="location">
                                    </i>Toronto
                                </b-link>
                            ...
                            <b-link target="_blank" class="group-category" title="Environment">Environment</b-link>
                        </b-card-header>
                        <b-card-body>
                            <div class="content-block">
                                <b-link target="_blank" title="Grow Trees" class="card-title mb-2">Grow Trees – On the path to environment sustainability
                                </b-link>
                                <b-card-text>
                                ...
                                <div class="group-ratings">
                                    <span class="group-name">Tree Canada</span>
                                    <span class="ratings">
                 ...
                 <b-col lg="4" sm="6" class="card-outer" data-aos="fade-up">
                    <b-card no-body>
                        <b-card-header>
                            ...
                            <b-link target="_blank" class="group-category" title="Children">Children</b-link>
                        </b-card-header>
                        <b-card-body>
                            <div class="content-block">
                                <b-link target="_blank" title="Education Supplies" class="card-title mb-2">Education Supplies for Every Pair of Shoes Sold
                                </b-link>
                                <b-card-text>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore...
                                </b-card-text>
                                <div class="group-ratings">
                                    <span class="group-name">Australian Paradise</span>
                                    <span class="ratings">
                                        <StarRating :config="config" :ratings="3"></StarRating>
                                    </span>
                                </div>
                 ...
                 <b-col lg="4" sm="6" class="card-outer" data-aos="fade-up">
                    <b-card no-body>
                        <b-card-header>
                            ...
                            <b-link target="_blank" class="group-category" title="Nutrition">Nutrition</b-link>
                        </b-card-header>
                        <b-card-body>
                            <div class="content-block">
                                <b-link target="_blank" title="Nourish the Children" class="card-title mb-2">Nourish the Children in African country 
                                </b-link>
                                <b-card-text>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt
                                ...
                                <div class="group-ratings">
                                    <span class="group-name">The Hunger</span>
                                    <span class="ratings">
                                        <StarRating :config="config" :ratings="3"></StarRating>
                                    </span>
                                </div>
                 ...
                 <b-col lg="4" sm="6" class="card-outer" data-aos="fade-up" data-aos-delay="400">
                    <b-card no-body>
                        <b-card-header>
                            <div class="header-img-block">
                                <b-link class="group-img" :style="{backgroundImage: 'url('+grpImages[3]+')'}">
                                    <img src="../assets/images/landing/group-img1.png" alt="group-img">
                                </b-link>
                                <b-link href="#" class="location" title="location">
                                    <i>
                 ...
                 <b-col lg="4" sm="6" class="card-outer" data-aos="fade-up" data-aos-delay="400">
                    <b-card no-body>
                        <b-card-header>
                            <div class="header-img-block">
                                <b-link class="group-img" :style="{backgroundImage: 'url('+grpImages[4]+')'}">
                                    <img src="../assets/images/landing/group-img1.png" alt="group-img">
                                </b-link>
                                <b-link href="#" class="location" title="location">
                                    <i>
                            ...
                            <b-link target="_blank" class="group-category" title="Animals">Animals</b-link>
                        </b-card-header>
                        <b-card-body>
                            <div class="content-block">
                 ...
                 <b-col lg="4" sm="6" class="card-outer" data-aos="fade-up" data-aos-delay="400">
                    <b-card no-body>
                        <b-card-header>
                            <div class="header-img-block">
                                <b-link class="group-img" :style="{backgroundImage: 'url('+grpImages[5]+')'}">
                                    <img src="../assets/images/landing/group-img1.png" alt="group-img">
                                </b-link>
                                <b-link href="#" class="location" title="location">
                                    <i>
                            ...
                            <b-link target="_blank" class="group-category" title="Health">Health</b-link>
                        </b-card-header>
                        <b-card-body>
                            <div class="content-block">
                 ...
                 <b-col lg="4" sm="6" class="card-outer" data-aos="fade-up">
                    <b-card no-body>
                        <b-card-header>
                            <div class="header-img-block">
                                <b-link class="group-img" :style="{backgroundImage: 'url('+grpImages[6]+')'}">
                                    <img src="../assets/images/landing/group-img1.png" alt="group-img">
                                </b-link>
                                <b-link href="#" class="location" title="location">
                                    <i>
                            ...
                            <b-link target="_blank" class="group-category" title="Education">Education</b-link>
                        </b-card-header>
                        <b-card-body>
                            <div class="content-block">
                                <b-link target="_blank" title="Grow Trees" class="card-title mb-2">Grow Trees – On the path to environment sustainability
                        ...
                        <b-card-footer>
                            <b-button class="btn-bordersecondary icon-btn" title="View details">
                ...
                <b-col lg="4" sm="6" class="card-outer" data-aos="fade-up">
                    <b-card no-body>
                        <b-card-header>
                            <div class="header-img-block">
                                <b-link class="group-img" :style="{backgroundImage: 'url('+grpImages[7]+')'}">
                                    <img src="../assets/images/landing/group-img1.png" alt="group-img">
                                </b-link>
                                <b-link href="#" class="location" title="location">
                                    <i>
                 ...
                 <b-col lg="4" sm="6" class="card-outer" data-aos="fade-up">
                    <b-card no-body>
                        <b-card-header>
                            <div class="header-img-block">
                                <b-link class="group-img" :style="{backgroundImage: 'url('+grpImages[8]+')'}">
                                    <img src="../assets/images/landing/group-img1.png" alt="group-img">
                                </b-link>
                                <b-link href="#" class="location" title="location">
                                    <i>
                        ...
                        <b-card-body>
                            <div class="content-block">
                                ...
                                <div class="group-ratings">
                                    <span class="group-name">Junior Charity</span>
                                    <span class="ratings">
                                        <StarRating :config="config" :ratings="3"></StarRating>
                                    </span>
                                </div>
