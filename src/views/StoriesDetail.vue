          ...
          <b-row>
            <b-col xl="9" lg="8"  class="slider-col">
              <div class="title-block">
                ...
                <div class="view-tag">
                  <i>
                    <img src="../assets/images/eye-ic.svg" alt="Eye Icon" />
                  </i>
                ...
                <b-col xl="2" class="right-col">
                  <slick ref="slick" :options="slickOptions" class="gallery-thumbs">
                    ...
                    <div class="video-block thumbs-col">
                      <img
                        src="http://i3.ytimg.com/vi/YE7VzlLtp-4/hqdefault.jpg"
              ...
              <div class="profile-box">
                <div class="user-profile">
                  <i
                    ...
                    :style="{backgroundImage: 'url(' + profileImg[0] + ')'}"
                  ></i>
                  <h4>Charles Vigue</h4>
                  <p>New York, USA</p>
                </div>
                <div class="profile-content">
                  ...
                  <p>Ut enim ad minim veniam. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                </div>
              </div>
            </b-col>
