        ...
        <b-form class="signin-form">
          <b-form-group :state="false">
            ...
            <b-form-input
              ...
              :class="{ 'is-invalid': $v.resetPassword.password.$error }"
              value="Password"
              placeholder="Enter Password"
              autofocus
            ></b-form-input>
            <div
              v-if="submitted && !$v.resetPassword.password.required"
              class="invalid-feedback"
            >Password is required</div>
            <div
              v-if="submitted && !$v.resetPassword.password.minLength"
              class="invalid-feedback"
            >Password lenght should be minimum 8 character</div>
          </b-form-group>
          ...
          <b-form-group>
            ...
            ></b-form-input>
            <div
              v-if="submitted && !$v.resetPassword.confirmPassword.required"
              class="invalid-feedback"
            >Confirm Password is required</div>
            <div
              v-if="submitted && !$v.resetPassword.confirmPassword.minLength"
              class="invalid-feedback"
            >Confirm Password lenght should be minimum 8 character</div>
            <div
              v-if="submitted && $v.resetPassword.confirmPassword.required && $v.resetPassword.confirmPassword.minLength && !$v.resetPassword.confirmPassword.sameAsPassword"
              class="invalid-feedback"
...
export default {
  ...
  methods: {
    handleSubmit(e) {
      ...
      axios
        .put(process.env.VUE_APP_API_ENDPOINT + "password_reset", {
