...
class ApplyMigration extends Command
{
     ...
     * @var string
     */
    protected $description = "It will apply migration changes to all tenant's database";
    ...
    public function handle()
    {
        ...
        if ($tenants->count() > 0) {
            ...
            $this->info("\nIt is going to apply migration changes\n");
            $bar->start();
