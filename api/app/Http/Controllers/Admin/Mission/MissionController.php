    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validator = Validator::make(
            ...
            [
                ...
                'donation_attribute.goal_amount' => 'sometimes|required_if:mission_type,DISASTER_RELIEF|numeric|min:1',
                'donation_attribute.show_goal_amount' => 'sometimes|required|in:0,1',
                'donation_attribute.show_donation_percentage' => 'sometimes|required|in:0,1',
                'donation_attribute.show_donation_meter' => 'sometimes|required|in:0,1',
                'donation_attribute.show_donation_count' => 'sometimes|required|in:0,1',
                'donation_attribute.show_donors_count' => 'sometimes|required|in:0,1',
                'donation_attribute.disable_when_funded' => 'sometimes|required|in:0,1',
                'donation_attribute.is_disabled' => 'sometimes|required|in:0,1',
            ]
        );
    ...
    public function update(Request $request, int $missionId): JsonResponse
    {
        ...
        $validator = Validator::make(
            ...
            [
                ...
                'donation_attribute.goal_amount_currency' => 'sometimes|required|string|min:3|max:3',
                'donation_attribute.goal_amount' => 'sometimes|required_if:mission_type,DISASTER_RELIEF|numeric|min:1',
                'donation_attribute.show_goal_amount' => 'sometimes|required|in:0,1',
                'donation_attribute.show_donation_percentage' => 'sometimes|required|in:0,1',
                'donation_attribute.show_donation_meter' => 'sometimes|required|in:0,1',
