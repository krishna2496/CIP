...
class Mission extends Model
{
    ...
    'mission_title', 'mission_objective', 'label_goal_achieved', 'label_goal_objective', 'state', 'state_name', 'organization', 'organization_name', 'missionTab', 'impactDonation'
    ];
    ...
    protected $cascadeDeletes = ['missionDocument','missionMedia','missionLanguage',
        ...
        'goalMission','timeMission','comment','timesheet', 'missionTab', 'impactDonation'
    ];
