...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'impact_donation.*.amount' => 'impact_donation_amount',
        'impact_donation.*.translations' => 'impact_donation_translations',
        'impact_donation.*.translations.*.language_code' => 'impact_donation_language_code',
        'impact_donation.*.translations.*.content' => 'impact_donation_content',
