...
class AlterColumnStatusIdInTimesheetTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('timesheet', function (Blueprint $table) {
            \DB::statement("ALTER TABLE `timesheet` CHANGE `status_id` `status` ENUM('PENDING','APPROVED','DECLINED','AUTOMATICALLY_APPROVED','SUBMIT_FOR_APPROVAL') NULL DEFAULT NULL");
        });
    }
